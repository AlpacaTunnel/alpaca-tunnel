all:
	gcc -std=gnu99 main.c aes.c log.c secret.c ip.c tunnel.c cmd_helper.c route.c config.c data-struct/*.c -lpthread -lm -o alpaca-tunnel -Wall -O3

debug:
	gcc -std=gnu99 main.c aes.c log.c secret.c ip.c tunnel.c cmd_helper.c route.c config.c data-struct/*.c -lpthread -lm -o alpaca-tunnel -Wall -g

test:
	gcc -std=gnu99 test.c aes.c log.c secret.c ip.c tunnel.c cmd_helper.c route.c config.c data-struct/*.c -lpthread -lm -o alpaca-tunnel -Wall -g
